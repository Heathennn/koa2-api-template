...
export const sendemail = (receivers, subject, text, html) => {
  return new Promise(function (resolve) {
    const transporter = nodemailer.createTransport('smtp://' + SendEmail.username + ':' + SendEmail.password + '@' + SendEmail.service); // setup e-mail data with unicode symbols

    const mailOptions = {
      from: SendEmail.sender_address,
      // sender address
      to: receivers,
      subject: subject,
